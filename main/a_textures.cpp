...
namespace {
    ...
    Group* imageTexturesBorder() {
        ...
        ImageTexture* clampTex = new ImageTexture("models/assignments/stones_diffuse.png", ImageTexture::CLAMP, ImageTexture::NEAREST);
        FlatMaterial* clamp = new FlatMaterial(clampTex);

        ImageTexture* mirrorTex = new ImageTexture("models/assignments/stones_diffuse.png", ImageTexture::MIRROR, ImageTexture::BILINEAR);
    ...
    Group* imageTexturesInterpolate() {
        ...
        ImageTexture* nearTex = new ImageTexture("models/assignments/stones_diffuse.png", ImageTexture::REPEAT, ImageTexture::NEAREST);
        FlatMaterial* near = new FlatMaterial(nearTex);

        ImageTexture* interTex = new ImageTexture("models/assignments/stones_diffuse.png", ImageTexture::REPEAT, ImageTexture::BILINEAR);
