...
void a7prepMaterials3(Material** materials) {
    ...
    CombineMaterial* cm1 = new CombineMaterial();
    cm1->add(new LambertianMaterial(blacktex, greentex), 0.5f);
    cm1->add(new PhongMaterial(whitetex, 10.0f), 0.5f);
    materials[2] = cm1;

    CombineMaterial* cm2 = new CombineMaterial();
    cm2->add(new LambertianMaterial(blacktex, whitetex), 0.3f);
    cm2->add(new FlatMaterial(bluetex), 0.3f);
    cm2->add(new PhongMaterial(whitetex, 10.0f), 0.4f);
    materials[3] = cm2;
...
void a_materials() {
    ...
    a7renderCornellbox(0.001f, "materials-combine.exr", materials);
    delete [] materials;
}