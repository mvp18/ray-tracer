...
void a_cameras() {
    ...
    EnvironmentCamera ecam(Point(0, 0, 0), Vector(0.1f, 0.1f, 1), Vector(0.2f, 1.0f, 0.2f), pi * 0.9f, pi * 0.9f);
    Renderer r3(&ecam,0);
    r3.test_render2(img);
    img.writeEXR("a1-5.exr");

    FisheyeCamera fcam(Point(0, 0, 0), Vector(0.1f, 0.1f, 1), Vector(0.2f, 1.0f, 0.2f), pi/3);
    Renderer r4(&fcam,0);
    r4.test_render2(img);
